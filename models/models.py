...
class Nutricionista(Base, UserMixin):
    ...
    nutri_senha = mapped_column(String(500), nullable=False)  # Aumente o tamanho para o hash
...
class Consulta(Base):
    ...
    con_reg_con_id = mapped_column(Integer, ForeignKey('tb_registro_consulta.reg_con_id'))
    con_exames_id = mapped_column(Integer, ForeignKey('tb_exames.exame_id'))
